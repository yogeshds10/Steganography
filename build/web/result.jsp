                ...
                <div class="wrapper">
                    <nav>
                        <ul id="menu">
                            ...
                            <li><a href="LoginHandler"><span>L</span>ogout</a></li>
                        </ul>
                    </nav>
                </div>
            ...
            <section id="content">
                <div class="wrapper">
                    <article class="col1">
                        ...
                        <form id="ContactForm">
                            <div class="textarea_box"> <span>Encrypted Text:</span>
                                <textarea name="textarea" cols="1" rows="1"><%=request.getAttribute("result")%></textarea>
                            </div>
                        </form>
                    </article>
                    <article class="col2">
