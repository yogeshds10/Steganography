                ...
                <div class="wrapper">
                    <nav>
                        <ul id="menu">
                            ...
                            <li id="menu_active"><a href="decryption.jsp"><span>D</span>ecryption</a></li>
            ...
            <section id="content">
                <div class="wrapper">
                    <article class="col1">
                        ...
                        <form action="DecryptServlet" method="post" enctype="multipart/form-data" id="ContactForm">
                            ...
                            <input type="submit" value="Decrypt" class="send"/>
                        </form>                        
                    </article>
                    <article class="col2">
                        <h3>Latest Works</h3>
